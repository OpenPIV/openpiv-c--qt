...
TEST_CASE("ImageAlgosTest - FFTTest")
{
    ...
    REQUIRE( save_to_file( "fft-output.pgm", GFImage( output ) ) );
...
{
    // load images
    auto im = load_from_file< GF >( "corr_a.tiff" );
...
TEST_CASE("ImageAlgosTest - FFTRealTest")
{
    ...
    REQUIRE( save_to_file( "fft_corr_a_fourier.pgm", GFImage{ output }) );
    ...
    REQUIRE( save_to_file( "fft_corr_a_conj.pgm", GFImage{ output }) );
    ...
    // write output
    REQUIRE( save_to_file( "fft_corr_a_output.pgm", GFImage{ output }) );
}
